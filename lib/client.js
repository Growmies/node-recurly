          ...
          res.on('end', function () {
            ...
            if (match) {
              ...
              return parser.parseString(responsedata, function (err, result) {
                masterList = masterList.concat(dottie.get(result, pathToDataArr));
              ...
              try {
                ...
                if (res.statusCode >= 200 && res.statusCode <= 299) {
                  ...
                  return parser.parseString(responsedata, function (err, result) {
                    //var data = dottie.get(result, pathToDataArr);
                    //data = masterList.concat(data);
                    dottie.set(result, pathToDataArr, masterList.concat(dottie.get(result, pathToDataArr)));
