  ...
  module.exports = function(config){
    ...
    this.accounts = {
      list: function(callback, filter){
        t.request(utils.addQueryParams(routes.accounts.list, filter), callback, null, [], 'accounts.account');
      },
      get: function(accountcode, callback){
        t.request(utils.addParams(routes.accounts.get, {account_code: accountcode}), callback, null, [], 'accounts.account');
      },
      create: function(details, callback){
        t.request(routes.accounts.create, callback, new Js2xml('account',details).toString(), [], 'accounts.account');
      },
      ...
      close: function(accountcode, callback){
        t.request(utils.addParams(routes.accounts.close, {account_code: accountcode}), callback, null, [], 'accounts.account');
      },
    ...
    this.billingInfo = {
      update: function(accountcode, details, callback){
        t.request(utils.addParams(routes.billingInfo.update, {account_code: accountcode} ), callback, new Js2xml('billing_info', details).toString(), [], 'billingInfos.billingInfo');
      },
      get: function(accountcode, callback){
    ...
    this.coupons = {
      list: function(callback, filter){
        t.request(utils.addQueryParams(routes.coupons.list, filter), callback, null, [], 'coupons.coupon');
      },
    ...
    this.couponRedemption = {
      ...
      remove: function(accountcode, callback){
        t.request(utils.addParams(routes.couponRedemption.remove, {account_code: accountcode}), callback, null, [], 'couponRedemptions.couponRedemption');
      },
    ...
    this.invoices = {
      list: function(callback, filter){
        t.request(utils.addQueryParams(routes.invoices.list, filter), callback, null, [], 'invoices.invoice');
      },
      listByAccount: function(accountcode, callback, filter){
        t.request(
          ...
          , callback, null, [], 'invoices.invoice')
      },
    ...
    this.plans = {
      list: function(callback, filter){
        t.request(utils.addQueryParams(routes.plans.list, filter), callback, null, [], 'plans.plan');
      },
    ...
    this.planAddons = {
      list: function(plancode, callback, filter){
        t.request(utils.addParams(utils.addQueryParams(routes.planAddons.list, filter), {plan_code: plancode}), callback, null, [], 'planAddons.planAddon');
      },
    ...
    this.subscriptions = {
      list: function(callback, filter){
        t.request(utils.addQueryParams(routes.subscriptions.list, filter), callback, null, [], 'subscriptions.subscription');
      },
      ...
      create: function(details, callback){
        t.request(routes.subscriptions.create, callback, new Js2xml('subscription', details).toString(), [], 'subscriptions.subscription');
      },
      update: function(uuid, details, callback){
        t.request(utils.addParams(routes.subscriptions.update, {uuid: uuid}), callback, new Js2xml('subscription', details).toString(), [], 'subscriptions.subscription');
      },
    ...
    this.transactions = {
      list: function(callback, filter){
        t.request(utils.addQueryParams(routes.transactions.list, filter), callback, null, [], 'transactions.transaction');
      },
      listByAccount: function(accountCode, callback, filter){
        t.request(
          utils.addParams(
